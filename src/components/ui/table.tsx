...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-x-auto border borderDarkMode bgDarkMode rounded">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b whitespace-nowrap", className)} {...props} />
));
